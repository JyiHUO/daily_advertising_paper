...
![Incentive-Aware Multi-Fidelity Optimization for Generative Advertising in Large Language Models 论文机制总览图](assets/figures/overview/incentive-aware-multi-fidelity-optimization-for-generative-advertising-in-large--hero.svg)
...
*图示：用核心积木和小分镜，把“多保真度搜索框架”讲成一眼就能懂的工作流程。*
...
*图示：用核心积木和小分镜，把“VCG激励兼容层”讲成一眼就能懂的工作流程。*
...
*图示：用核心积木和小分镜，把“主动反事实优化ACO”讲成一眼就能懂的工作流程。*
...
*图示：用核心积木和小分镜，把“两种实例化的互补性”讲成一眼就能懂的工作流程。*
...
*图示：用核心积木和小分镜，把“语义过饱和与福利权衡”讲成一眼就能懂的工作流程。*
...
*图示：该图是“Overview of NestPipe”，直接展示了论文核心方法的两层嵌套流水线：inter-batch 的 dual-buffer pipelining 和 intra-batch 的 frozen-window pipelining，能清楚体现模块关系、时间调度与训练加速机制，比 Fig.1 的系统背景架构更能代表论文方法本身。该候选裁剪也更干净完整，正文噪声更少，主体聚焦优于对应 block 版本。*
...
*图示：用核心积木和小分镜，把“双缓冲流水线消除lookup延迟”讲成一眼就能懂的工作流程。*
...
*图示：用核心积木和小分镜，把“冻结窗口流水线隐藏All2All通信”讲成一眼就能懂的工作流程。*
...
*图示：用核心积木和小分镜，把“Key中心样本聚类优化去重”讲成一眼就能懂的工作流程。*
...
*图示：用核心积木和小分镜，把“理论一致性保证”讲成一眼就能懂的工作流程。*
...
*图示：用核心积木和小分镜，把“大规模实验与正交可组合性”讲成一眼就能懂的工作流程。*
